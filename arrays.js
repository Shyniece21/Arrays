var familyMembers = ["Annette", "Alex Jr.", "Alex III", "Alexis"];
//Using the pop array method removes the last element from the array.
family.pop();
console.log(family);


var numbers = [08, 06, 12, 04]
...
//I utilized index positions in my number variable that I created above. When using the slice array method I had to know which position corresponded with the elements I wanted to access.